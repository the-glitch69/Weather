...
def display_weather(data):
    ...
    print(border_color + "=" * 33)
    print(header_color + " Weather Information ".center(33, "="))
    print(border_color + "=" * 33)
    print(f"{key_color}City:".ljust(25) + f"{value_color}{location}".rjust(26))
    print(f"{key_color}Region:".ljust(25) + f"{value_color}{region}".rjust(26))
    print(f"{key_color}Country:".ljust(25) + f"{value_color}{country}".rjust(26))
    print(border_color + "-" * 33)
    print(f"{key_color}Local Time:".ljust(25) + f"{value_color}{local_time}".rjust(26))
    print(f"{key_color}Condition:".ljust(25) + f"{value_color}{current_condition}".rjust(26))
    print(f"{key_color}Temperature:".ljust(25) + f"{value_color}{temperature}°C".rjust(26))
    print(f"{key_color}Humidity:".ljust(25) + f"{value_color}{humidity}%".rjust(26))
    print(f"{key_color}Wind Speed:".ljust(25) + f"{value_color}{wind_speed} kph".rjust(26))
    print(f"{key_color}Wind Direction:".ljust(25) + f"{value_color}{wind_degree}° {wind_direction}".rjust(26))
    print(border_color + "=" * 33)
